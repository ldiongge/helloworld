    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-trans layui-form-item layadmin-user-login-other">
          ...
          <a href="${pageContext.request.contextPath }/to/Toreg" class="layadmin-user-jump-change layadmin-link">注册帐号</a>
        </div>
      </div>
    </div>
      ...
      //  url: layui.setter.base + 'doAdmin/login' //实际使用请改成服务端真实接口
       url:  '${pageContext.request.contextPath }/admin/login'
        ...
        ,done: function(res){
          ...
          var admin=JSON.stringify(res.data);
          ...
          if(res.data!=null){
            layer.msg('登入成功', {
              ...
              location.href = '${pageContext.request.contextPath }/to/ToAdminindex'; //后台主页
            });
          }else {
            layer.msg('登入失败', {
              offset: '15px'
